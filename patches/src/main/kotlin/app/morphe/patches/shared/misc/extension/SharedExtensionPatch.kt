// Forked from: https://github.com/ReVanced/revanced-patches/blob/6b06b9d1328b971a06d10b4247f4c10f050e4f61/patches/src/main/kotlin/app/revanced/patches/shared/misc/extension/SharedExtensionPatch.kt
...
/**
 * Creates an extension hook using a fingerprint builder.
 *
 * @param insertIndexResolver Resolver for the instruction index to insert the hook.
 * @param contextRegisterResolver Resolver for the register which contains the application context.
 * @param builder The fingerprint builder.
 */
fun extensionHook(
    insertIndexResolver: BytecodePatchContext.(Method) -> Int = { 0 },
    contextRegisterResolver: BytecodePatchContext.(Method) -> String = { "p0" },
    builder: FingerprintBuilder.() -> Unit,
) = ExtensionHook(
    fingerprint(builder),
    insertIndexResolver,
